        ...
        <div class="content-inner">
            ...
            <section>
                <div class="container-fluid fa-lang">
					...
					?>
					<br>
					  <a href="<?php print BASE_URL; ?>fdt/01.php?path=dir1" class="btn btn-success">Dir1 List</a>
					  <a href="<?php print BASE_URL; ?>fdt/01.php?path=dir2" class="btn btn-success">Dir2 List</a>
                </div>
            </section>
