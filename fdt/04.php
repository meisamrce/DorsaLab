        ...
        <div class="content-inner">
            ...
            <section>
                <div class="container-fluid fa-lang">
					...
					?>
					<br>
					  <a href="<?php print BASE_URL; ?>fdt/04.php?path=a.txt" class="btn btn-success">File 1</a>
					  <a href="<?php print BASE_URL; ?>fdt/04.php?path=b.txt" class="btn btn-success">File 2</a>
                </div>
            </section>
