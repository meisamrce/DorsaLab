        ...
        <div class="content-inner">
            ...
            <section>
                <div class="container-fluid fa-lang">
				    <a href="<?php print BASE_URL ?>/lfi/06.php?page=home.php" class="btn btn-success">Home</a>
				    <a href="<?php print BASE_URL ?>/lfi/06.php?page=about.php" class="btn btn-success">About us</a>
				    <a href="<?php print BASE_URL ?>/lfi/06.php?page=contact.php" class="btn btn-success">Contact us</a>
					<br>
					<br>		
					<?php
						$page = $main->get('page');
