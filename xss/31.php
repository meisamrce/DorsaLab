<?php
	...
	if($main->post('btn_add'))
	{
		...
		$msg = $main->post('msg');
		$title = preg_replace('/<script>/i',"", $title);
		$title = preg_replace('/<\/script>/i',"", $title);
                ...
                <div class="container-fluid fa-lang">
					...
					<form method="post" action="" autocomplete="off">
					  <div class="form-group">
						...
						<input maxlength="20" type="text" class="form-control" id="title" name="title">
					  </div>
					  <div class="form-group">
						<label for="msg">Message :</label>
						<textarea maxlength="20" class="form-control" id="msg" name="msg"></textarea>
					  </div>
