<?php
	...
	if($main->post('btn_add'))
	{
		...
		$msg = htmlentities($main->post('msg'),ENT_QUOTES,'UTF-8');
                ...
                <div class="container-fluid fa-lang">
					...
					<form method="post" action="" autocomplete="off">
					  <div class="form-group">
						<label>Title :</label>
						Hi <input type="radio"  name="title" value="Hi">
						&nbsp;&nbsp;
						Salam <input type="radio"  name="title" value="Salam">
						&nbsp;&nbsp;
						Test <input type="radio"  name="title" value="Test">
						&nbsp;&nbsp;
					  </div>
					  <div class="form-group">
